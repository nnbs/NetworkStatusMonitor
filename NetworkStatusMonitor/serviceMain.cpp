...
int __cdecl _tmain(int argc, TCHAR* argv[])
{
    ...
    {
        extern int StartMonitorWorker(bool bWait);
        StartMonitorWorker(true);
        return 0;
    }
...
VOID SvcInit(DWORD dwArgc, LPTSTR* lpszArgv)
{
    ...
    extern int StartMonitorWorker(bool bWait);
    StartMonitorWorker(false);

    while (1)
    {
        // Check whether to stop the service.
        //SvcReportEvent((LPTSTR)L"Wait STOPED");
